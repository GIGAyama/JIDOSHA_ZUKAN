...
| デモ（3Dだけ） | `demo3d.html` |
| たしかめ | `selftest.html`（イラストの 動き・36 checks）／ `selftest3d.html`（3Dの 動き・1331 checks） |
...
- **詳細ページ**: 絵が 3Dに なり、ゆびで まわせます。「📷 しゃしんで 見る」で いつでも もどれます
  （写真の ない 車では「🖼️ イラストで 見る」と 出ます）
...
- **ものすごい かんさつ**が 3D版に なります（`kansatsu3d.js`）。
  くらい 部屋・◯印・✓の ほぞん・こえで きく は SVG版と 同じ。
